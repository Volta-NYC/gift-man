      ...
      <div className="section-shell grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        ...
        {giftCard ? (
          <ProductImage
            ...
            alt={giftCard.title}
            priority
            className="aspect-[4/3] rounded-[8px] border border-ink-900/10 bg-white shadow-soft"
            imageClassName="object-contain p-8"
            sizes="(min-width: 1024px) 45vw, 100vw"
          />
        ) : (
          <div className="rounded-[8px] border border-ink-900/10 bg-white p-8 shadow-soft">
