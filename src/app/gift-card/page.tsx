  ...
  return (
    <section className="bg-cream-50 py-12 sm:py-16">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:px-8">
        <div>
          <p className="mb-3 text-sm font-black uppercase tracking-[0.16em] text-coral-700">Gift Card</p>
        ...
        {giftCard ? (
          <ProductImage
            ...
            alt={giftCard.title}
            priority
            className="aspect-[4/3] rounded-[8px] shadow-soft"
            imageClassName="object-contain p-8"
            sizes="(min-width: 1024px) 45vw, 100vw"
          />
        ) : (
          <div className="rounded-[8px] border border-stone-200 bg-white p-8 shadow-soft">
            <div className="aspect-[4/3] rounded-[8px] bg-[linear-gradient(135deg,#161313,#3a312d)] p-8 text-white">
              ...
              <p className="mt-3 text-sm font-black uppercase tracking-[0.18em] text-coral-200">Brooklyn Gifts</p>
            </div>
          </div>
        )}
      </div>
